...
function placeXOrO(squareNumber) {
    //this condition ensures a square hasnt been selected alrd
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))){
        ...
        if (activePlayer === 'O'){
            //this function disabled checkings for computer turns
            disableClick();
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //this condition allows our while loop to keep trying if a square is selected alrd
        while (!success) {
...
//the below define checkWinConditions, audio anddisableClick
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.moveTo(x1, y1);
        //this method indivates the end point in our line
        c.lineTo(x, y);
